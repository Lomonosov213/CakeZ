...
// дабавил класс нажатому блоку, остальным удалил
$('.menu__linl').click(function () {
...
$('.sec31__sizes-item').click(function () {
   if (!$(this).hasClass('_active')) {
      $(this).siblings().removeClass('_active');
      $(this).addClass('_active');
   }
...
//  обложк для видоса, которая исчезает при клике ========================================================================================================================================================
...
window.onload = function () {
   ...
   $(".img-play").on("click", function () {
      $(this).hide();
      $(".play").attr('src', 'Summer.mp4')
      $(".play").addClass('visible')

   });

   $(".img-play2").on("click", function () {
      $(this).hide();
      $(".play2").attr('src', 'Summer.mp4')
      $(".play2").addClass('visible')
   });

   $(".img-play3").on("click", function () {
      $(this).hide();
      $(".play3").attr('src', 'Summer.mp4')
      $(".play3").addClass('visible')
   });

   $(".img-play4").on("click", function () {
      $(this).hide();
      $(".play4").attr('src', 'Summer.mp4')
      $(".play4").addClass('visible')
   });

   $(".img-play5").on("click", function () {
      $(this).hide();
      $(".play5").attr('src', 'Summer.mp4')
      $(".play5").addClass('visible')
   });

   $(".img-play6").on("click", function () {
      $(this).hide();
      $(".play6").attr('src', 'Summer.mp4')
      $(".play6").addClass('visible')
   });

   $(".img-play7").on("click", function () {
      $(this).hide();
      $(".play7").attr('src', 'Summer.mp4')
      $(".play7").addClass('visible')
   });

   $(".img-play8").on("click", function () {
      $(this).hide();
      $(".play8").attr('src', 'Summer.mp4')
      $(".play8").addClass('visible')
   });

   $(".img-play9").on("click", function () {
      $(this).hide();
      $(".play9").attr('src', 'Summer.mp4')
      $(".play9").addClass('visible')
   });

   $(".img-play10").on("click", function () {
      $(this).hide();
      $(".play10").attr('src', 'Summer.mp4')
      $(".play10").addClass('visible')
   });
...
$(".img-play").on("click", function () {
   $(this).hide();
   $(".play").attr('src', 'https://youtu.be/rZbDuO-Ks3k;autoplay=1')
});
*/


// проверка инпута на наличие данных, и добавлеие класса другому блоку
...
(function ($) {
   ...
   $(function () {
      ...
      $('.rf').each(function () {
         ...
         var form = $(this);
         var block = $('.sec21__pool-cakeWrapp');

         // Добавляем каждому проверяемому полю, указание что поле пустое
         block.find('.pool-cake__secret-info').addClass('_notactive');
         // $('.pool-cake__secret-info').addClass('_active');
         // Функция проверки полей формы
         function checkInput() {
            form.find('.rfield1').each(function () {
               if ($(this).val() != '') {
                  // Если поле не пустое удаляем класс-указание

                  $('.pool-cake__secret-info').addClass('_active');

                  // $('.pool-cake__secret-info').removeClass('_active');
               } else {
                  // Если поле пустое добавляем класс-указание
                  $('.pool-cake__secret-info').removeClass('_active');
                  // $('.pool-cake__secret-info').addClass('_active');
...
(function ($) {
   ...
   $(function () {
      ...
      $('.rf2').each(function () {
         ...
         // Добавляем каждому проверяемому полю, указание что поле пустое
         block.find('.pool-cake__secret-info2').addClass('_notactive');
         // $('.pool-cake__secret-info').addClass('_active');
         // Функция проверки полей формы
         function checkInput() {
            form.find('.rfield2').each(function () {
               if ($(this).val() != '') {
                  ...
                  $('.pool-cake__secret-info2').addClass('_active');

                  // $('.pool-cake__secret-info').removeClass('_active');
               } else {
                  // Если поле пустое добавляем класс-указание
                  $('.pool-cake__secret-info2').removeClass('_active');
                  // $('.pool-cake__secret-info').addClass('_active');
               }
            });
         }
...
(function ($) {
   ...
   $(function () {
      ...
      $('.rf3').each(function () {
         ...
         // Добавляем каждому проверяемому полю, указание что поле пустое
         block.find('.pool-cake__secret-info3').addClass('_notactive');
         // $('.pool-cake__secret-info').addClass('_active');
         // Функция проверки полей формы
         function checkInput() {
            form.find('.rfield3').each(function () {
               if ($(this).val() != '') {
                  // Если поле не пустое удаляем класс-указание

                  $('.pool-cake__secret-info3').addClass('_active');

                  // $('.pool-cake__secret-info').removeClass('_active');
               } else {
                  // Если поле пустое добавляем класс-указание
                  $('.pool-cake__secret-info3').removeClass('_active');
                  // $('.pool-cake__secret-info').addClass('_active');
               }
            });
         }
...
(function ($) {
   ...
   $(function () {
      ...
      $('.rf4').each(function () {
         ...
         // Добавляем каждому проверяемому полю, указание что поле пустое
         block.find('.pool-cake__secret-info4').addClass('_notactive');
         // $('.pool-cake__secret-info').addClass('_active');
         // Функция проверки полей формы
         function checkInput() {
            form.find('.rfield4').each(function () {
               if ($(this).val() != '') {
                  // Если поле не пустое удаляем класс-указание

                  $('.pool-cake__secret-info4').addClass('_active');

                  // $('.pool-cake__secret-info').removeClass('_active');
               } else {
                  // Если поле пустое добавляем класс-указание
                  $('.pool-cake__secret-info4').removeClass('_active');
                  // $('.pool-cake__secret-info').addClass('_active');
               }
            });
         }
...
(function ($) {
   ...
   $(function () {
      ...
      $('.rf5').each(function () {
         ...
         // Добавляем каждому проверяемому полю, указание что поле пустое
         block.find('.pool-cake__secret-info5').addClass('_notactive');
         // $('.pool-cake__secret-info').addClass('_active');
         // Функция проверки полей формы
         function checkInput() {
            form.find('.rfield5').each(function () {
               if ($(this).val() != '') {
                  // Если поле не пустое удаляем класс-указание

                  $('.pool-cake__secret-info5').addClass('_active');

                  // $('.pool-cake__secret-info').removeClass('_active');
               } else {
                  // Если поле пустое добавляем класс-указание
                  $('.pool-cake__secret-info5').removeClass('_active');
                  // $('.pool-cake__secret-info').addClass('_active');
               }
            });
         }
...
(function ($) {
   ...
   $(function () {
      ...
      $('.rf6').each(function () {
         ...
         // Добавляем каждому проверяемому полю, указание что поле пустое
         block.find('.pool-cake__secret-info6').addClass('_notactive');
         // $('.pool-cake__secret-info').addClass('_active');
         // Функция проверки полей формы
         function checkInput() {
            form.find('.rfield6').each(function () {
               if ($(this).val() != '') {
                  // Если поле не пустое удаляем класс-указание

                  $('.pool-cake__secret-info6').addClass('_active');

                  // $('.pool-cake__secret-info').removeClass('_active');
               } else {
                  // Если поле пустое добавляем класс-указание
                  $('.pool-cake__secret-info6').removeClass('_active');
                  // $('.pool-cake__secret-info').addClass('_active');
               }
            });
         }
...
// сворачивание блоков при клике на стрелку ========================================================================================================================================================


$('.sec37__news-title').on('click', function () {
   if ($('.sec37__news-arr').hasClass("_active")) {
      $('.sec37__news-arr').removeClass('_active');
      $('.sec37__news-text').slideToggle();
   } else {
      $('.sec37__news-arr').addClass('_active');
      $('.sec37__news-text').slideToggle();
   }
})

$('.sec37__news-title2').on('click', function () {
   if ($('.sec37__news-arr2').hasClass("_active")) {
      $('.sec37__news-arr2').removeClass('_active');
      $('.sec37__news-text2').slideToggle();
   } else {
      $('.sec37__news-arr2').addClass('_active');
      $('.sec37__news-text2').slideToggle();
   }
})

$('.sec37__news-title3').on('click', function () {
   if ($('.sec37__news-arr3').hasClass("_active")) {
      $('.sec37__news-arr3').removeClass('_active');
      $('.sec37__news-text3').slideToggle();
   } else {
      $('.sec37__news-arr3').addClass('_active');
      $('.sec37__news-text3').slideToggle();
   }
})
...
function updateCountdown() {
   const hours = Math.floor(timeD / 3600);
...
// для сворачивания бургера ========================================================================================================================================================

$('.menu__linl').on('click', function () {
   if ($('.menu__body').hasClass("_active")) {
...
/*
$(".calculator-block__choise-box .calculator-block__icon").click(function () {
   // alert('hi');
   $(this).parents(".calculator-block__icon-wrapp").toggleClass("active-icon"); //добавляем класс текущей (нажатой)
})
